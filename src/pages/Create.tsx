          ...
          {step === 1 ? (
            ...
            <div className="text-center py-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                {formData?._id ? (
                  <Link to={`/portfolio/${formData._id}`} className="bg-[#7127BA] hover:bg-[#8138d1] text-white font-semibold px-8 py-2 rounded">
                    View Your Portfolio
                  </Link>
                ) : (
                  <p className="text-gray-400">No portfolio ID found. Please try again.</p>
                )}
